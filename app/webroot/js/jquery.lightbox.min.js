...
g])}for(;a.imageArray[a.activeImage][0]!=c.getAttribute("href");)a.activeImage++;if(a.grouping&&e){d=e;e=false}i()}function q(){b("body").append('<div id="jquery-overlay"></div><div id="jquery-lightbox"><div id="lightbox-container-image-box" style="overflow: visible!important;"><div id="lightbox-container-image"><img id="lightbox-image"><div style="" id="lightbox-nav"><a href="#" id="lightbox-nav-btnPrev"></a><a href="#" id="lightbox-nav-btnNext"></a></div><div id="lightbox-loading"><a href="#" id="lightbox-loading-link"><img src="'+
a.imageLoading+'"></a></div></div><div id="lightbox-container-image-data-box"><div id="lightbox-container-image-data"><div id="lightbox-image-details"><span id="lightbox-image-details-caption"></span><span id="lightbox-image-details-currentNumber"></span></div><div id="lightbox-secNav"><a href="#" id="lightbox-secNav-btnClose"><img src="'+a.imageBtnClose+'"></a></div></div></div></div></div>');var c=k();b("#jquery-overlay").css({backgroundColor:a.overlayBgColor,opacity:a.overlayOpacity,width:c[0],
...
function r(c,d){
	//console.log('mona'+c+'kjshdgsd'+d);
	//console.log(a.containerBorderSize);
	var e=b("#lightbox-container-image-box").width(),h=b("#lightbox-container-image-box").height();
	/*if(a.shrinkToFit){
		var g=k(),f=l()[1]+g[3]/10,j=c/d;
		if(d>g[1]-f*2-a.shrinkPadding){d=g[1]-f*2-a.shrinkPadding;c=d*j
	}
	if(c>g[0]-a.shrinkPadding){
		c=g[0]-a.shrinkPadding;d=c/j}
	}*/
	g=c+a.containerBorderSize*2;
	f=d+a.containerBorderSize*2;
	//g=615;
	//f=446;
	//width: 715px; height: 546px;
	//console.log('mona1'+g+'kjshd1'+f);
	//alert('mona1'+g+'kjshd1'+f);
	e-=g;
	h-=f;
	
	b("#lightbox-container-image-box").animate({width:g,height:f},a.containerResizeSpeed,function(){s()});
	if(e==0&&h==0)b.browser.msie?o(250):o(100);b("#lightbox-container-image-data-box").css({width:c});b("#lightbox-nav-btnPrev,#lightbox-nav-btnNext").css({height:d+a.containerBorderSize*2})
}
	
	function s(){b("#lightbox-loading").hide();
...
overlayOpacity:0.8,fixedNavigation:false,imageLoading:lightbox_path+"/images/lightbox-ico-loading.gif",imageBtnPrev:lightbox_path+"/images/lightbox-btn-prev.gif",imageBtnNext:lightbox_path+"/images/lightbox-btn-next.gif",imageBtnClose:lightbox_path+"/images/close.png",imageBlank:lightbox_path+"/images/lightbox-blank.gif",containerBorderSize:10,containerResizeSpeed:400,txtImage:"Image",txtOf:"of",keyToClose:"c",keyToPrev:"p",keyToNext:"n",imageArray:[],activeImage:0,captionPosition:"",shrinkToFit:true,

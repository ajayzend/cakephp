...
<div class="box-header well">
					...
					<div class="box-content">
						...
						<table class="table table-striped table-bordered bootstrap-datatable datatable custom_table" id="show_search_client">
						  <thead>
							   <tr  class="colr_body">
					 ...
					 <?php if (!empty($users))
					  ...
					  ?>
							<tr class="odd colr_body">
									...
									<td class="center"><?php echo h($row['User']['first_name'])." ".h($row['User']['last_name']); ?></td>
									...
									<td class="center ">
											<?php 
											echo date('d-M-Y',strtotime($row['User']['created']));
											?>
									</td>

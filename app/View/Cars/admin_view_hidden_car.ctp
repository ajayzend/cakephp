					...
					<div class="row">
						<div class="col-md-6">
							<div class="addcar">
								...
								?>
								<div class="form-group col-md-6" id="engineNo" style="<?php echo $style; ?>" >
						...
						<div class="col-md-6 dollar_exchange">
						...
						<!--	<h4>Calculator</h4>-->
							<div class="row">
								<div class="control-group col-md-3">
									...
									<div class="controls">
										<?php echo $this->Form->input('push_price',array('type'=>'text','value'=>@$carDetails['CarPayment']['push_price'],'class'=>'form-control ','label'=>false,'id'=>'push_id','onkeypress'=>"return allownumber(event)"));?>
									</div>
								</div>
								<div class="control-group col-md-3">
									<label class="control-label" for="inputbodystyle">Tax (%)</label>
									<div class="controls">
										<?php echo $this->Form->input('tax',array('type'=>'text','class'=>'form-control ','value'=>@$tax_value,'label'=>false,'id'=>'tax_id','onkeypress'=>"return allownumber(event)"));?>
									</div>
								</div>
								<div class="control-group col-md-6">
									<label class="control-label" for="inputbodystyle">Net Push Price </label>
									<div class="controls">
										<?php echo $this->Form->input('net_push',array('type'=>'text','class'=>'form-control ','label'=>false,'id'=>'net_push_id','onkeypress'=>"return allownumber(event)",'value'=>@$carDetails['CarPayment']['net_push']));?>
									</div>
								</div>
							</div>
							<div class="row">
								...
								<div class="control-group col-md-6"> 
									...
									<div class="controls">
										<?php echo $this->Form->input('auction_fee',array('type'=>'text','value'=>@$carDetails['CarPayment']['auction_fee'],'label'=>false,'class'=>'form-control ','id'=>'main_select_fee','onkeypress'=>"return allownumber(event)",'required'=>true));?>
									</div>
								</div>
							</div>
						  <div class="row">
							...
							<?php echo $this->Form->input('transport_id',array('type'=>'select','options'=>$transports,'class'=>'input-large','class'=>'form-control','id'=>'transports_id','data-rel'=>'chosen','empty'=>'Select Transports Company','value'=>@$value,'label'=>false));?>
							  ...
							  <div class="control-group col-md-6" id="PortdataId">
								...
								<div class="controls">
									...
									<?php 
									 ...
									 foreach($AuctionDetail as $key=>$val){
										$loaderId = $val['Auction']['id'];?>
											<div id="ajax-loading<?php echo $loaderId;?>" style="display:none;"><div id="circularG">
							...
							<div class="control-group col-md-6">
								...
								<div class="controls">
									<?php echo $this->Form->input('rickshaw',array('type'=>'text','value'=>@$carDetails['CarPayment']['rickshaw'],'label'=>false,'class'=>"form-control",'id'=>'main_rickshaw_id','onkeypress'=>"return allownumber(event)",'required'=>true));?> 
								</div>
							</div>
							<div class="control-group col-md-6">
								<label class="control-label" for="inputbodystyle">Shipping</label>
								<div class="controls">
									<?php echo $this->Form->input('shiping_fee',array('type'=>'text','value'=>@$carDetails['CarPayment']['shiping_fee'],'class'=>'form-control ','label'=>false,'id'=>'main_shipping_id','onkeypress'=>"return allownumber(event)",'required'=>true));?>
								</div>
							</div>
							<div class="control-group col-md-6">
								<label class="control-label" for="inputbodystyle">Freight </label>
								<div class="controls">
									<?php echo $this->Form->input('freight',array('type'=>'text','value'=>@$carDetails['CarPayment']['freight'],'label'=>false,'class'=>'form-control ','id'=>'main_freight_id','onkeypress'=>"return allownumber(event)",'required'=>true));?>
								</div>
							</div>
							<div class="control-group col-md-6">
								<label class="control-label" for="inputbodystyle">Others</label>
								<div class="controls">
									<?php echo $this->Form->input('other',array('type'=>'text','value'=>@$carDetails['CarPayment']['other'],'class'=>'form-control ','label'=>false,'id'=>'mail_Others_id','onkeypress'=>"return allownumber(event)",'required'=>true));?>
								</div>
							</div>
							<div class="row">
							<div class="control-group col-md-6">
								...
								<div class="controls">
									<?php echo $this->Form->input('recycle_price',array('type'=>'text','value'=>@$carDetails['CarPayment']['recycle_price'],'class'=>'form-control ','label'=>false,'id'=>'recycle_price','onkeypress'=>"return allownumber(event)"));?>
								</div>
							</div>
								...
								<div class="control-group col-md-3 testing_text1">
									...
									<div class="controls">
										...
										<?php echo $this->Form->input('minimum_price_doller',array('type'=>'text','value'=>@$carDetails['CarPayment']['minimum_price_doller'],'class'=>'form-control ','label'=>false,'id'=>'minimum_price_doller','onkeypress'=>"return allownumber(event)"));?>
									</div>
								</div>
								<div class="control-group col-md-3 testing_text2">
									<label class="control-label" for="inputbodystyle">&nbsp;</label>	
									<div class="controls">
										<?php echo $this->Form->input('minimum_price_yen',array('type'=>'text','value'=>@$carDetails['CarPayment']['minimum_price_yen'],'class'=>'form-control ','label'=>false,'id'=>'minimum_price_yen','onkeypress'=>"return allownumber(event)"));?>
									</div>
								</div>
							</div>
						...
						<div class="row"> 		
						 ...
						 <div class="row">     
							...
							<div class="control-group col-md-3 margin-top_c pull-right" style="margin-left:20px !important;"> 
	...
	<!--  checked  box here  -->
						...
						<div class="form-group col-md-6">
							...
							<?php echo $this->Form->input('tab_id',array('type'=>'hidden','id'=>'tab1')); ?>
							  ...
							  <button type="submit" disabled=disabled class="btn btn-primary" id="submit">Save</button>
							  <a  class="btn btn-danger" href="<?php echo $this->Html->url('/admin/cars/hidden_car',true);?>">Cancel</a>
							</div>
				...
				<div class="row">
						...
						<!--<h4>Upload Images</h4>-->
							...
							<div class="Upload_imagearea" id="Upload_imagearea">
								...
								<div class="submit align_btn" style="margin-top:0px;margin-right:10px;">
										<a id="add_file" class="btn btn-primary" disabled=disabled href="javascript:void(0);"><?php echo __('Upload Image');?></a>
								</div>
					<input type="hidden" value="<?php echo (isset($car_id)? $car_id:'0');?>" name="data[Car][car_id]" data-id="car_id">
					<?php echo $this->Form->input('tab_id',array('type'=>'hidden','id'=>'tab2')); ?>
					<?php echo $this->Form->submit('Save',array('type'=>'button','id' =>'saveimg','class'=>'btn btn-primary save_cars','disabled'=>true)); ?>
					<div class="submit align_btn" style="margin-top:0px;"> <!-- Clearfix -->
							<a  class="btn btn-danger" href="<?php echo $this->Html->url('/admin/cars/hidden_car',true);?>">Cancel</a>
							<button class="btn btn-primary" data-toggle="modal" disabled=disabled data-target="#myModal" id="User_send-email">Send Image</button>
					...
					<button class="btn btn-primary dltone" disabled=disabled id="deleteCar" style=<?php echo $style; ?> onclick="checkDelete('<?php echo (isset($car_id)? $car_id:'0');?>')">Delete All</button>
					<?php }?>
						</div>
						</div>
				</div>
			...
			<div class=" tab-pane " id="about_shipment">
				...
				<div class="row">
					...
					<div class="col-md-12">
						...
						<input type="hidden" value="<?php echo (isset($car_id)? $car_id:'0');?>" name="data[Car][car_id]" data-id="car_id">
						<?php echo $this->Form->submit('Save',array('type'=>'button','class'=>'btn btn-primary','id'=>'send_sales','disabled'=>true));?>
				        <div class="submit"><a  class="btn btn-danger" href="<?php echo $this->Html->url('/admin/cars/hidden_car',true);?>">Cancel</a></div>
				...
				<div class="row">	
					...
					<div class="col-md-6">
						...
						<div class="form-group col-md-6">
							...
							<?php echo $this->Form->input('ship_port',array('type'=>'text','id'=>'ship_port','value'=>@$carDetails['Logistic']['ship_port'],'div'=>false,'label'=>false,'class'=>'form-control'));?>
						</div>
					...
					<div class="col-md-6">
						...
						<div class="form-group col-md-6">
							...
							<?php echo $this->Form->input('arrival_date',array('type'=>'text','id'=>'arrival_date','value'=>@$carDetails['Logistic']['arrival_date'] ,'div'=>false,'label'=>false,'class'=>'.datepicker form-control'));?>
						</div>
					</div>
					<div class="col-md-6">	
					    <div class="form-group col-md-6">
					...
					<div class="col-md-12">
						<div class="form-group col-md-12">
							<input type="hidden" value="<?php echo (isset($car_id)? $car_id:'0');?>" name="data[Car][car_id]" data-id="car_id">
							<?php echo $this->Form->submit('Save',array('type'=>'button','class'=>'btn btn-primary','id'=>'logistic_car','disabled'=>true));?>
							<div class="submit">
								<a  class="btn btn-danger" href="<?php echo $this->Html->url('/admin/cars/hidden_car',true);?>">Cancel</a>
							</div>
						</div>			   
							...
							'success':function(result)
								{
											...
											}else if(obj.status == 'successWithError')
											{
												$('#messageDivForImage').html(obj.message);
												$('#messageDivForImage').show();
											}
				...
				var imageName = eval("("+data+")")
					console.log(imageName);
					  //   $("#uploadDivLUl").append('<li class="add_imgnew" data-image="'+files+'"><i class="fa fa-times pull-right" onclick="removeTempImage(\''+files+'\');"></i><img src="<?php echo $this->webroot;?>files/post_files/'+files+'"></li>');
						...
						var str =  '<li data-image="'+i+'"  class="add_imgnew"><a href="javascript:void(0)" onclick="removeTempImage(\''+i+'\');" ><i  class="fa fa-times pull-right"></i></a> <img src="<?php echo $this->webroot; ?>files/post_files/'+i+'" alt="" /></li>';
						}else{
...
$('#select_auction').on('change', function(event) {	
   ...
   form = $("#overview").serialize();
    ...
    <!--      change price of Auction-->
      ...
      <!--      on select country show all releted fields -->
                ...
                <script>
						   ...
						   $('#Country_id').on('change', function(event) {
							...
							$('#main_freight_id').val(data[2]);
							$('#mail_Others_id').val(data[3]);	
						    
					   });
	 
	                 </script>
<!--      Open Popup To send car Images to client-->

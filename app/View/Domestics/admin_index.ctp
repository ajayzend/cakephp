...
<div class="box-header well">
						<div class="col-md-12"><h2><i class="fa fa-cogs">&nbsp;</i>Domestic Operations Management</h2></div>
					...
					<div class="row">
						...
						<a href="<?php echo $this->Html->url('/',true);?>admin/domestics/add" class='btn btn-primary btn-lg pull-right hint--bottom'> <i class="fa fa-plus-circle">&nbsp;</i>Add</a>
                        <a href="<?php echo $this->Html->url('/',true);?>admin/domestics/export" class='btn btn-primary btn-lg pull-right hint--bottom'> <i class="fa fa-plus-circle">&nbsp;</i>Export</a>
                        </div>
					</div>
					</div>
        ...
        <input type="hidden" name="modeval">
                        ...
                        <table class="table table-striped table-bordered bootstrap-datatable datatable custom_table">
							  ...
							  ?>
								<tr id="portId_<?php echo $val['Domestic']['id'];?>">
									<td class="center"><?php echo $val['Domestic']['sales_day']?></td>
									<td class="center"><?php echo $val['Domestic']['auction_name']?></td>
                                    <td class="center"><?php echo $val['Domestic']['indentification']?></td>
									<td class="center">
                                    	<a href="<?php echo $this->Html->url('/',true);?>admin/domestics/update/<?php echo $val['Domestic']['id'];?>"><button type="button" class='btn btn-info hint--bottom' ><i class="fa fa-pencil"></i></button></a>
						 
										<a href="javascript:checkDelete(<?php echo $val['Domestic']['id'];?>,<?php echo $pages;?>);" class='btn btn-danger hint--bottom' data-hint="Delete"><i class="fa fa-trash-o"></i></a>
...
<script>
	function delete_port(id,pageNo){
		...
		if(id!= undefined){
			$.ajax({
			   url:'<?php echo $this->Html->url('/admin/domestics/delete',true);?>',
			   type:'POST',
			   data:{'id':id},
			   dataType:'JSON',
			   success:function(data){
				if(data.status='success'){
					window.location = "<?php echo $this->Html->url('/admin/domestics');?>";
				}
			 }

...
<!-- content starts --> 	
	<div class="row sortable">		
		<div class="box col-md-12">
			...
			<?php
			 if(!empty($carDetails)){?>
				<h2><i class="fa fa-plus-circle"></i> <?php echo __('Edit Domestic Operations')?></h2>
				<?php }else{?>
					
					<h2><i class="fa fa-plus-circle"></i> <?php echo __('Add Domestic Operations')?></h2>
				...
				<!--form-1 here-->
					...
					<div class="row">
                        ...
                        <div class="control-group col-md-3">
                            ...
                            <div class="controls">
                                <?php echo $this->Form->input('auction_name',array('type'=>'text','class'=>'form-control ','label'=>false));?>
                            </div>
                        </div>
                        <div class="control-group col-md-3">
                            <label class="control-label" for="inputbodystyle">Vehicle identification number</label>
                            <div class="controls">
                                <?php echo $this->Form->input('indentification',array('type'=>'text','class'=>'form-control ','label'=>false));?>
                            </div>
                        </div>
                        <div class="control-group col-md-3"> 
                                <label class="control-label" for="inputbodystyle">Car model</label>
                                <div class="controls">
                                    <?php echo $this->Form->input('model',array('type'=>'text', 'label'=>false,'class'=>'form-control '));?>
                                </div>
                            </div>
					</div>
                    <div class="row">
							...
							<div class="control-group col-md-3">
								...
								<div class="controls">
									<?php echo $this->Form->input('car_price',array('type'=>'text','label'=>false,'class'=>'form-control '));?>
								</div>
							</div>
							<div class="control-group col-md-3">
								<label class="control-label" for="inputbodystyle">Exhibition Charge</label>
								<div class="controls">
									<?php echo $this->Form->input('exhibition',array('type'=>'text','class'=>'form-control ','label'=>false));?>
								</div>
							</div>
                   </div>
                   <div class="row">
                    ...
                    <div class="controls">
                    <?php echo $this->Form->input('contact_fee',array('type'=>'text','class'=>'form-control ','label'=>false));?>
                    </div>
                    </div>
                    <div class="control-group col-md-3">
                    ...
                    <div class="controls">
                    <?php echo $this->Form->input('payment_day',array('type'=>'text','class'=>'form-control ','label'=>false));?>
                    </div>
                    </div>     
                    <div class="control-group col-md-3">
                    <label class="control-label" for="inputbodystyle">Sales payment Bank</label>	
                    <div class="controls">
                    <?php echo $this->Form->input('payment_bank',array('type'=>'text','class'=>'form-control ','label'=>false));?>
                    </div>
                    </div>
                   </div>
                         ...
                         <div class="row">
							<div class="control-group col-md-3">
								...
								<div class="controls">
									<?php echo $this->Form->input('payment_amount',array('type'=>'text','label'=>false,'class'=>"form-control"));?>
								</div>
							</div>
                         </div>
						<div class="clearfix"></div>

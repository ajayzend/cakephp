...
<div class="row-fluid">	
	...
	<div class="box box_margn span12">
				...
				<div class="box-header well">
					...
					<button type="button" class="close product-featureclsbtn " data-dismiss="modal">x</button>
					<div class="err_msg session_msg"></div>
				</div>

		<div class="box-content slide_form">
		...
		function(data) {
			...
			// window.location="<?php echo $this->webroot;?>admin/sliderManagements/index";
				    ...
				    ?>
							...
							<div id='origin_key' name='origin' class='span6  '>
					...
					?>
							...
							<div id='drop_key' name='drop' class='span6 slide_key '  >
							<h6>Slide Feature</h6>
							<br/>
					...
					?>			
						...
						-->
							...
							<div class="span12 pull-right save_magin modal-footer"><a  onclick="update_order();" class="btn btn-info marginbtn ">Save</a></div>
							<?php

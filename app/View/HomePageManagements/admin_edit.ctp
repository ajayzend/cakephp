<div id="content1"> 
	<div class="box col-md-12">
		...
		<div class="report-management">
			...
			<div class="col-sm-12">
				<?php echo $this->Form->create('homePageManagements',array('action'=>'saveSlide/'.$this->params['pass'][0],'class'=>'add_home_mgmt','id'=>'slide_submit','enctype'=>'multipart/form-data')); ?>										
						...
						<div class='control-group'>
							<img id="target" height='366' width='852' src="<?php echo $this->webroot;?>img/HomePageManagements/<?php echo $selected_pro['HomePageSlide']['image_source'];?>" alt="" /><br/><br/>

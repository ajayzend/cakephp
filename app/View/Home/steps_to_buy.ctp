<div class="ProductDetailLeftPanel" style="padding:40px 0px;">
	<div class="col-lg-3">
        ...
        <div class="LeftStockRow" style="padding:15px 0px 15px 25px">
            <a href="<?php echo $this->Html->url('/',true); ?>home/steps_to_buy"><div class="StockPanelText" style="color:#55b640">Steps to Buy</div></a>
        </div>
        <div class="LeftStockRow" style="padding:15px 0px 15px 25px">
    ...
    <div class="col-lg-9">
    	<h1 class="PageTitle">Steps to <span>Buy</span></h1>

...
<div class="col-lg-9" style="position:relative;">
    ...
    <div class="col-lg-3 NoPaddingLeft">
        <div class="HomePagrCarListingDiv">
            ...
            <div class="HomePageListingCarPrice col-lg-7">
            <?php
            if($this->Session->read('LANGUAGE') == 2)
            {
            ...
            <div class="HomePageCarTypeDiv"><?=$SAC['Car']['fuel']?> | <?=$SAC['Car']['transmission']?></div>
            <div class="HomePageStockIdDiv">Stock Id - <?=$SAC['Car']['stock']?></div>
            </div>
            <div class="clearfix">&nbsp;</div>

  ...
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title" id="myModalLabel">Bizupon Car buy Form</h4>
      </div>
...
<div class="row car-details white-bg">
	...
	<?php  if(isset($this->request->params['named']['country'])) {?>
		
			<a class="btn btn-success pull-right go-back" href="<?php echo $this->Html->url(array('controller'=>'home','action'=>'stocklist','country'=>$countryName['Country']['id'],'brand'=>$brandName['Brand']['id'],'type'=>'1')); ?>">Go Back</a>
		
	<?php }else if(isset($this->request->params['named']['vtype'])){?>
			<a class=" btn btn-success pull-right go-back" href="<?php echo $this->Html->url(array('controller'=>'home','action'=>'allTruckStock','brand'=>$this->request->params['named']['brand'],'type'=>$this->request->params['named']['type'],'vtype'=>$this->request->params['named']['vtype']));?>">Go Back</a>
			
			<?php }else
			{ ?><a class=" btn btn-success pull-right go-back" href="<?php echo $this->Html->url(array('controller'=>'home','action'=>'showAllCar'));?>">Go Back</a>
				<?php }?>
	...
	else
	{
			$.ajax({
				...
				success:function(result)
				{
					...
					{
						$("#showmsg").html("<div id='success' style='color:green;margin-bottom: 2%;text-align:center'><strong>Success-  </strong>"+result.message+"</div>");
						$('#buyAmount').val(" ");
						setTimeout(function(){
					...
					{
						$("#showmsg").html("<div  id='err' style='color:red;margin-bottom: 2%;text-align:center'><strong>Error-  </strong>"+result.message+"</div>");
						$('#buyAmount').val(" ");
						setTimeout(function(){
						$( "div" ).removeClass( "modal-backdrop fade in");
						$("#myModal").modal('hide'); 

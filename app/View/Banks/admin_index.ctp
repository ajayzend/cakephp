...
<div class="box-header well">
						<div class="col-md-12"><h2><i class="fa fa-asterisk sidebar_ico_margin">&nbsp;</i>Bank Management</h2></div>
					...
					<div class="row">
						...
						<div>
						<input class="input-xlarge pull-left col-md-6" id="selectbox-o" name="optionvalue" data-placeholder="Enter Bank Name For Search">
						</div>
		...
		$(function()
		{
			$("#selectbox-o").change(function()
			{
				...
				$.ajax({
					...
					type:"POST",
					data:{name:$("#s2id_selectbox-o .select2-choice span").html(),id:$("#selectbox-o").val(),'pageNo':pageNo},
					dataType:"html",
					success:function(result)
					{

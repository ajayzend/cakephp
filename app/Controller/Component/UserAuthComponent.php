...
class UserAuthComponent extends Component {
	...
	function beforeFilter(&$c) {
		...
		$permissionFree=array('users/admin_login', 'users/logout', 'users/register', 'users/userVerification', 'users/forgotPassword', 'users/activatePassword', 'pages/display', 'users/accessDenied', 'users/emailVerification','story/storyTest');

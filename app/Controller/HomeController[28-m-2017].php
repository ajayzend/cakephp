...
class HomeController extends AppController {
	...
	public function index(){
		...
		$showAllCar = $this->Car->find('all' , array('conditions'=>array('Car.publish'=>1),'recursive'=>2, 'limit' => 12, 'order' => array('Car.id' => "DESC")));
   ...
   /*$this->Email->smtpOptions = array(
	...
	function filterStockList()
	{
		...
		$this->paginate=array('limit'=>12, 'fields'=> array("CarPaymentAls.*", "CarName.*", 'Car.*'), 'conditions'=>array(array('Car.publish'=>1, $Condition)), 'page' => $_POST['CurrentPage'], 'order' => $order, 'joins' => array(
        array(
            'alias' => 'CarPaymentAls',
            'table' => 'car_payments',
            'type' => 'left',
   ...
   function arrival_car_list()
   {
	...
	public function gatModel(){ 
      ...
      public function getCarInfo(){
		...
		echo json_encode(array("country_id"=>$this->data['countryId'],"brand_id"=>$this->data['brandId'],"carNames"=>$carName));
